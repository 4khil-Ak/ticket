                    ...
                    <div className="bg-img">
                        <div className="row">
                            ...
                            <div className="right">
                                ...
                                <button type="button" className="custom-button book-btn btn btn-warning" onClick={() => props.book(props.details.secret)}>Book TIcket</button>
                        ...
                        <div className="row mt-3 border-0">
                            <div className="d-flex flex-wrap col-12 col-md-6 col-lg-4 p-0 p-md-2 pb-0 mb-3 m-0 mb-md-0 item">
                                ...
                                <div className="row flex-column pl-3 border-0">
                                    <p className="venue">{props.details.venue}</p>
                            ...
                            <div className="d-flex flex-wrap col-12 col-md-6 col-lg-4 p-0 p-md-2 pb-0 mb-3 m-0 mb-md-0 item">
                                ...
                                <div className="row flex-column pl-3 border-0">
                                    <p className="venue">{props.details.location}</p>
                            ...
                            <div className="d-flex flex-wrap col-12 col-md-6 col-lg-4 p-0 p-md-2 pb-0 mb-3 m-0 mb-md-0 item">
                                ...
                                <div className="row flex-column pl-3 border-0">
                                    <p className="venue">{props.details.duration}&ensp;Mins</p>
