            ...
            <div className="row">
              ...
              <div className="right">
                <ul className="countdown">
                  ...
                  <li>
                    <h2>
                      <span className="seconds">16</span>
                    </h2>
                    <p className="seco_text">sec</p>
                  </li>
                </ul>
                {/* onClick={() => props.book(props.details.secret)} */}
                <button
                  type="button"
                  className="custom-button book-btn btn btn-warning"
                  onClick={props.bookMyTicket}
                >
                  Book Ticket
                </button>
